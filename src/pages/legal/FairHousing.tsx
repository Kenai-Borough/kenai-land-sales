    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-slate-300">
        ...
        <section id="prohibited-practices">
          ...
          <p className="mt-3">The following practices are prohibited on Kenai Land Sales:</p>
          <ul className="mt-2 list-disc list-inside space-y-1">
        ...
        <section id="reporting">
          ...
          <p className="mt-3">If you have experienced or witnessed housing discrimination on Kenai Land Sales, you can:</p>
