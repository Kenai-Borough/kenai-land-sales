    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-slate-300">
        <section id="acceptance">
          ...
          <p className="mt-3">By accessing or using Kenai Land Sales ("kenailandsales.com"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the platform. These Terms constitute a legally binding agreement between you and Kenai Peninsula Network / Kenai Borough LLC ("we," "us," or "our").</p>
        ...
        <section id="description">
          ...
          <p className="mt-3">Kenai Land Sales (kenailandsales.com) is a For Sale By Owner (FSBO) land and acreage marketplace that connects land sellers directly with buyers on the Kenai Peninsula, Alaska. The platform provides listing tools, due diligence resources, and informational content to support direct land transactions.</p>
        </section>
        ...
        <section id="third-party">
          ...
          <h2 className="text-2xl font-semibold text-white" id="real-estate">8. Real Estate and Land Sale Disclaimers</h2>
          <p className="mt-3">Kenai Land Sales is not a licensed real estate brokerage and does not provide real estate advice, appraisals, or legal counsel. All FSBO sellers are solely responsible for compliance with Alaska real estate disclosure laws, including requirements under AS 34.70. Sellers must accurately represent parcel boundaries, access rights, utility availability, and any known encumbrances.</p>
          <p className="mt-3">The platform does not guarantee the accuracy of any listing information, including property condition, legal description, title status, boundary surveys, zoning, or environmental conditions. Buyers should conduct their own due diligence, including obtaining independent title searches, boundary surveys, soil tests, and access verification. Consult a licensed Alaska attorney before closing any land transaction.</p>
        ...
        <section id="contact">
          ...
          <ul className="mt-2 space-y-1">
            ...
            <li>Website: <a href="https://kenailandsales.com" className="text-sky-400 hover:underline">kenailandsales.com</a></li>
