  ...
  export const SITE_NAME = 'land'
  export const SITE_LABEL = 'Kenai Land Sales'
  export const SITE_DOMAIN = 'https://kenailandsales.com'
  export const DEFAULT_ROLE = 'seller'
  ...
  export const SITE_ROLE_OPTIONS = [
    { value: 'buyer', label: 'Find parcels' },
{ value: 'seller', label: 'Sell land' },
